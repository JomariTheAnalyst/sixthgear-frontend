      ...
      const response = await fetch(
        ...
        }/store/contact-inquiries`,
        {
          ...
          body: JSON.stringify({
            ...
            subscribed_to_newsletter: formData.subscribe,
          }),
        }
      )
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="relative w-full h-[400px] md:h-[500px] rounded-[2rem] overflow-hidden mb-8">
          ...
          <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 flex gap-4">
            ...
            <LocalizedClientLink
              href="/faq"
              className="flex items-center gap-4 bg-white/90 backdrop-blur-sm text-gray-900 px-6 py-4 rounded-xl min-w-[180px] hover:bg-white transition-colors"
            >
            ...
            {isSubmitted ? (
              <div className="text-center py-20">
                ...
                <button
                  ...
                  className="text-[#F16D34] font-medium underline"
                >
                  Send another
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex items-start gap-3 pt-2">
                  ...
                  <label
                    htmlFor="subscribe"
                    className="text-sm text-[#4a4a4a] cursor-pointer selection:bg-none"
                  >
                    Subscribe to keep up with our upcoming events, opportunities
                    and programs
                  </label>
                </div>
