...
export const metadata: Metadata = {
  title: "Preview - Home",
  description: "Preview mode for Strapi CMS content",
}
 ...
 *
 * This page is ONLY used for Strapi preview mode and is embeddable in an iframe.
 * It renders the same content as the homepage but with draft content enabled.
 *
...
export default async function PreviewPage() {
  ...
  // If draft mode is not enabled, redirect to homepage
  // This prevents direct access to /preview without going through /api/preview
  if (!isEnabled) {
    console.log("[PreviewPage] Draft mode not enabled, redirecting to homepage")
    redirect("/ph")
  }

  console.log("[PreviewPage] Rendering in draft mode")

  // Use default region for preview (can be made dynamic if needed)
